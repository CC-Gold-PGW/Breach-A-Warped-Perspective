...
currentLocation = 0
#Tracks the player finding a health kit and using the medbay
HealthFound = 0
MedBayUsed = 0
#------------------------------------------------------------------------------
...
#Some enemies switch their attack preference when reduced below 1/2 HP
    ...
    if AttackChoice == 1:
        print("The enemy focuses on defending itself...")
    elif AttackChoice == 2:
        print("The enemy gears up for an all out assault...")
    else:
        print("The enemy prepares for a counter attack...")
...
#Main combat function.  Loops until combat ends, and is in charge of calling the other combat functions
    ...
    while playerHP > 0 or MobCurrentHP > 0:
        ...
        if playerHP <= 0:
            ...
            while True:
                ...
                if fight == 4:
                    ...
                    if HealthKitUsed == True:
                        ...
                        continue
                if fight == 1:
                    print("You attack carefully, ready to defend yourself...")
                    HealthKitUsed = False
                    break
                elif fight == 2:
                    print("You prepare for an all out assault...")
                    HealthKitUsed = False
                    break
                elif fight == 3:
                    print("You ready yourself for a counter attack...")
                    HealthKitUsed = False
                    break
            ...
            ChoiceOutcome = ""
            RollComparisonOutcome = ""
            #Rock Paper Scissors Test
            #1 Defensive beats 3 Opportunistic
            #2 Offensive beats 1 Defensive
            #3 Opportunistic beats 2 Offensive
            if (fight,mobAttack) in ((1,2),(2,3),(3,1)) or HealthKitUsed == True:
                ChoiceOutcome = "Lose"
            elif (fight,mobAttack) in ((1,3),(2,1),(3,2)):
                ChoiceOutcome = "Win"
            else:
                ChoiceOutcome = "Draw"

            #Roll Comparison
            if (playerAttackResult,mobAttackResult) in (("Crits","Misses"),("Hits","Misses")):
                RollComparisonOutcome = "Win"
            elif (playerAttackResult,mobAttackResult) in (("Misses","Crits"),("Misses","Hits")):
                RollComparisonOutcome = "Lose"
            elif (playerAttackResult,mobAttackResult) in ("Misses","Misses"):
                RollComparisonOutcome = "Miss"
            else:
                RollComparisonOutcome = "Draw"

            #Outcome Test
            if RollComparisonOutcome == "Miss":
                if HealthKitUsed == True:
                ...
                continue
            elif (ChoiceOutcome,RollComparisonOutcome) in (("Win","Win"),("Win","Draw"),("Draw","Win")):
                ComWin(playerAttackResult, mobAttackResult)
            elif (ChoiceOutcome,RollComparisonOutcome) in (("Lose","Lose"),("Lose","Draw"),("Draw","Lose")):
...
#Medbay Function
def UseMedBay():
    global MedBayUsed, playerHP, playerMaxHP

    if MedBayUsed == 0:
        print("You lie down on one of the beds.  It is hard, barely more than a metal box and seemingly made of the same material as the walls and floor.  Fortunately your suit’s soft inner lining ensures you remain fairly comfortable regardless.")
        print("")
        input("Press Enter to Continue")
        print("")
        print("After a few seconds the machine to the side of the bed whirs and springs to life.  A band of pale blue light sweeps over your body, not dissimilar to the first-aid’s scanner.")
        print("")
        input("Press Enter to Continue")
        print("")
        print("Afterwards, the machine extends several arms ending in small circular objects.  The edges are rounded and slightly concave giving it the look of one of those ancient sensor dishes you could find in a museum.  You are glad they aren’t saws, at any rate.")
        print("")
        input("Press Enter to Continue")
        print("")
        print("The machine holds them about half a metre above your body, and they begin to glow and hum.  The areas on your body they are pointing it begin tingling.")
        print("")
        input("Press Enter to Continue")
        print("")
        print("It's not unpleasant, but you get the distinct feeling of something crawling inside you which unnerves you.  It moves them in methodical sweeps over your body and the feeling moves with it, like a thousand fingers poking and prodding inside you.")
        print("")
        playerHP = playerMaxHP
        input("Press Enter to Continue")
        print("")
        print("After sweeping your entire body, the machine retracts, beeps once and is still.  You swing your legs out from the bed and stand up, almost leaping into the air as you do so.  Confused, you flex your legs.")
        print("")
        input("Press Enter to Continue")
        print("")
        print("You feel stronger somehow, as if all the fatigue you didn’t even know you felt had just been swept away.  Examining your body all your injuries seem to have been completely healed as well.")
        print("")
        input("Press Enter to Continue")
        print("")
        print("Needless to say, the treatment worked.  You are reassured with the knowledge that even if you are mortally injured in this place, if you can return here those wounds can be healed.")
        print("")
        input("Press Enter to Continue")
        print("")
    else:
        print("You lie down on a bed again, and let the machine tend to your wounds.  While the machine is effective, you can’t say you could ever get used to the feeling of it messing with your innards.")
        print("")
        playerHP = playerMaxHP
        input("Press Enter to Continue")
        print("However, once it finishes and you feel that same surge of vitality you are intensely glad that it is exists and can used freely. ")
        print("")
        input("Press Enter to Continue")
        print("")
#===============================================================================
...
def room4():
    ...
    global enter4
    global currentLocation
    global heal, HealthFound, MedBayUsed
    move =0
    currentLocation = 4
    ...
    if enter4 ==0:
        ...
        if HealthFound == 0:
            ...
            print("You recognise the object as another of those alien first aid kits.")
            print("")
            input("Press Enter to Continue")
            print("eagerly pick it up and let it fold into its compact form before tucking it into one of your pockets, pleased with your find.")
            print("")
            input("Press Enter to Continue")
        ...
        input("Press Enter to Continue")
        print("")
        print("You consider trying to lie down on one of the beds, reasoning the machinery next to each bed must be some sort of medical equipment.")
        print("")
        input("Press Enter to Continue")
        print("")
        print("it is automatic it might be able to treat your wounds if you were injured.  Should you give it a try?")
        print("")
        print("1: Try to use Medbay")
        print("2: Leave")
        move = validateNum(move,1,2)
        if move == 1:
            UseMedBay()
        ...
        print("As the door slides open the alien medbay is revealed much as you had left it.")
        print("")
        input("Press Enter to Continue")
        print("")
        print("You consider trying to lie down on one of the beds, reasoning the machinery next to each bed must be some sort of medical equipment.  If it is automatic it might be able to treat your wounds if you were injured.  Should you give it a try?")
        print("")
        print("1: Try use Medbay")
        print("2: Leave")
...
def room7():
    ...
    if enter7 == 0:
        ...
        input("Press Enter to Continue")
        print ("")
        print ("The robot's lurch becomes a fall and the robot crashes to the ground, the damaged arm finally separating and skidding a few additional few meters.")
